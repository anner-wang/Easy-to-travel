...
public class DrivingRouteOverlay extends RouteOverlay {
    ...
    public String ColorStrin="#537edc";
     ...
     * 添加驾车路线添加到地图上显示。
     */
    public void addToMap(AMap.OnMarkerClickListener onMarkerClickListener) {
        initPolylineOptions();
        try {
            if (mAMap == null) {
                return;
            ...
            addStartAndEndMarker(onMarkerClickListener);
    ...
    private void initPolylineOptions() {
        ...
        mPolylineOptions.color(this.getDriveColor()).width(getRouteWidth());
    }
    ...
    protected int getDriveColor() {
        return Color.parseColor(ColorStrin);
    }
}
